...
Daily Life Toolkit ("we", "us", or "our") operates the Daily Life Toolkit mobile application (the "App"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our App.

### 1. Information Collection and Use

Our App is designed to prioritize your privacy. We focus on **offline-first** functionality and local data storage.
...
All financial data, budget details, and personal notes created within the App are stored **locally on your device**. We do not have access to your private data.

### 3. Third-Party Services

We use Google ML Kit for on-device processing. We also use In-App Purchases which may collect data according to Google's Privacy Policy.
